...
def get_pie_chart(entered_site):
    # Use filtered_df based on the selected site
    filtered_df = spacex_df if entered_site == 'ALL' else spacex_df[spacex_df['Launch Site'] == entered_site]

    # Create pie chart
    fig = px.pie(filtered_df, names='class', title='Success vs. Failure for Selected Launch Site')
    return fig
...
def update_scatter_chart(selected_site, payload_range):
    ...
    filtered_df = spacex_df[(spacex_df['Launch Site'] == selected_site) | (selected_site == 'ALL')]
